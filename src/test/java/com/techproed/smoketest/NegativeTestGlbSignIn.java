...
public class NegativeTestGlbSignIn {
    ...
    public void negativeTest(){
        ...
        glbSignInPage.email.sendKeys(ConfigReader.getProperty("invalid_test_email"));
        glbSignInPage.password.sendKeys(ConfigReader.getProperty("invalid_test_password"));
